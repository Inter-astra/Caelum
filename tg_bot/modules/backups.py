...
def import_data(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        ...
        try:
            ...
            msg.reply_text(
                "An error occurred while recovering your data. The process failed. If you experience a problem with this, please take it to @CaelumSupport"
            )
...
def export_data(update, context):
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Caelumet_bot{}.backup".format(chat_id), "rb"),
    ...
    os.remove("Caelumbet_bot{}.backup".format(chat_id))  # Cleaning file
